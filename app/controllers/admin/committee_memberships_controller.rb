...
class Admin::CommitteeMembershipsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     CommitteeMembership: create, read, update, destroy, custom_action
  #
  #   editor:
  #     CommitteeMembership: create, read, update, custom_action_for_an_item
  #

...
class Admin::CommitteesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Committee: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Committee: create, read, update, custom_action_for_an_item
  #

...
class Admin::PoliticiansController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Politician: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Politician: create, read, update, custom_action_for_an_item
  #

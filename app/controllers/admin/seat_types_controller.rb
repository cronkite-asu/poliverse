...
class Admin::SeatTypesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     SeatType: create, read, update, destroy, custom_action
  #
  #   editor:
  #     SeatType: create, read, update, custom_action_for_an_item
  #

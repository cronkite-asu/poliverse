...
class Admin::CountiesController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     County: create, read, update, destroy, custom_action
  #
  #   editor:
  #     County: create, read, update, custom_action_for_an_item
  #
